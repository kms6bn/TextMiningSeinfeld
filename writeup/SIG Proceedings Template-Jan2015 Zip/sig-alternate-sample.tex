...
\conferenceinfo{CS Text Mining}{'97 El Paso, Texas USA}
...
This creative and expensive process touches a number of people starting from pitching ideas for shows to actual filming the season. Our research touches on a middle ground of that process. We analyze the relationship between the words of the script and its outcome in ratings, both in quality and in viewership. In other areas, text mining has 
...
\subsubsection{Target Shuffling}

\section{Analysis}
We're taking our model to wall street
